...
class LiveOffExchange:
    ...
    def process_data(self, endpoint, data_directory):
        ...
        if response_json is not None:
            ...
            json_filename = os.path.join(data_directory, "live_offexchange.json")
            csv_filename = os.path.join(data_directory, "live_offexchange.csv")
...
if __name__ == "__main__":
    ...
    live_offexchange_endpoint = "/beta/live/offexchange"
    data_directory = "data"

    live_offexchange = LiveOffExchange(token_file_path)
    live_offexchange.process_data(live_offexchange_endpoint, data_directory)
