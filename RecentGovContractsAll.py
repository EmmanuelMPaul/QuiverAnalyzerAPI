...
class RecentGovContractsAll:
    ...
    def process_data(self, endpoint, data_directory):
        ...
        if response_json is not None:
            ...
            json_filename = os.path.join(data_directory, "recent_govcontractsall.json")
            csv_filename = os.path.join(data_directory, "recent_govcontractsall.csv")
...
if __name__ == "__main__":
    ...
    recent_govcontractsall_endpoint = "/beta/live/govcontractsall"
    data_directory = "data"

    recent_govcontractsall = RecentGovContractsAll(token_file_path)
    recent_govcontractsall.process_data(recent_govcontractsall_endpoint, data_directory)
