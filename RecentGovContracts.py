...
class RecentGovContracts:
    ...
    def process_data(self, endpoint, data_directory):
        ...
        if response_json is not None:
            ...
            json_filename = os.path.join(data_directory, "recent_govcontracts.json")
            csv_filename = os.path.join(data_directory, "recent_govcontracts.csv")
...
if __name__ == "__main__":
    ...
    recent_govcontracts_endpoint = "/beta/live/govcontracts"
    data_directory = "data"

    recent_govcontracts = RecentGovContracts(token_file_path)
    recent_govcontracts.process_data(recent_govcontracts_endpoint, data_directory)
